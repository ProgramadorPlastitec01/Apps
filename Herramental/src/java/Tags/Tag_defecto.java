    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            if (!lst_defectos.isEmpty()) {
                ...
                out.print("<td class='estatico' align='center' colspan='3'><b>Codigo: </b><b class='negro'>R-GC-211</b><hr /><b>Version: </b><b class='negro'>000</b></td>");
                out.print("</tr>");
                out.print("<tr>");
                out.print("<td class='estatico3' colspan='6' style='background: #CAA427;'></td>");
                out.print("</tr>");
                out.print("<tr>");
                ...
                out.print("<td class='estatico3' align='center' style='width:2%;font-weight: bold;'>OPC</td>");
                out.print("</tr>");
