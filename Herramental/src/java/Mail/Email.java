...
public class Email {
    ...
    public boolean mail_Pendiente_herramental(String id_usuarios, List lst_pendiente, String usuario) throws javax.mail.MessagingException, Exception {
...
// </editor-fold>
    ...
    public boolean mail_Pendiente_maquina(String id_usuarios, List lst_pendiente) throws javax.mail.MessagingException, Exception {
        UsuarioJpaController jpa_usuario = new UsuarioJpaController();
        lst_conf = Configuracion.ConsultaConfCorreo();
        if (lst_conf != null) {
            String[] ArrMail = lst_conf.toString().split("///");
    ...
    public boolean mail_Pendiente_Ficha_t(String cargos, List lst_fichaT) throws javax.mail.MessagingException, Exception {
        UsuarioJpaController jpa_usuario = new UsuarioJpaController();
        lst_conf = Configuracion.ConsultaConfCorreo();
        if (lst_conf != null) {
            String[] ArrMail = lst_conf.toString().split("///");
    ...
    public boolean mail_Movimiento_maquina(String id_usuarios, List lst_movimiento, String usuario) throws javax.mail.MessagingException, Exception {
        UsuarioJpaController jpa_usuario = new UsuarioJpaController();
    ...
    public boolean mail_Firma_Desmontado(List lst_movimiento) throws javax.mail.MessagingException, Exception {
    ...
    public boolean mail_notificacion_defecto(List lst_defecto) throws javax.mail.MessagingException, Exception {
