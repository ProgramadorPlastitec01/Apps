 ...
 * Autor:LBVP
    ...
    public static void main(String[] args) {
        ...
        File FOrigen = new File("\\\\172.16.2.115\\e$\\Simobi\\Fotos\\");
        //Fichero donde se van a copiar los datos
        File FDestino = new File("C:\\Users\\Prog.sistemas1\\Documents\\Desarrollo_2018\\Proyectos_desarrollo\\SIRH\\web\\");
 ...
 *PARAMETRO2:FDestino:Carpeta destino
    ...
    public static void CopiarFichero(File FOrigen, File FDestino) {
        try {
            ...
            File f2 = new File(FOrigen.toString().replace("", "").replace(" ", ""));
            FOrigen.renameTo(f2);
            if (FOrigen.exists()) {
                String copiar = "S";
