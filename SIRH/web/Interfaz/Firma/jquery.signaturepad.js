...
$.fn.signaturePad.defaults = {
  ...
  , errorMessage : 'Pendiente ingresar firma' // The error message displayed on invalid submission
  , errorMessageDraw : 'Pendiente ingresar firma' // The error message displayed when drawOnly and no signature is drawn
