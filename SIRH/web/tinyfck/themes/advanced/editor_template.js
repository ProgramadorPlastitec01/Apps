...
//                    theme_advanced_buttons1: "fontselect,fontsizeselect,bold,italic,underline,strikethrough,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,bullist,numlist,separator,outdent,indent,separator,link,unlink,anchor,image,cleanup,code,hr,removeformat,visualaid,separator,sub,sup,separator,charmap",
                    theme_advanced_buttons1: "fontselect,fontsizeselect,bold,italic,underline,strikethrough,separator,justifyleft,justifycenter,justifyright,justifyfull,separator",
                    theme_advanced_buttons2: "bullist,numlist,separator,outdent,indent,separator,link,unlink,anchor,image,cleanup,code,hr,removeformat,visualaid,separator,sub,sup,separator,charmap",
                };
