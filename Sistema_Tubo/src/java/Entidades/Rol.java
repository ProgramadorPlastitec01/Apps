...
@NamedQueries({
    ...
    , @NamedQuery(name = "Rol.findByUsuarioRegistro", query = "SELECT r FROM Rol r WHERE r.usuarioRegistro = :usuarioRegistro")
...
public class Rol implements Serializable {
    ...
    public Rol(Integer idRol, String nombre, int estado, String usuarioRegistro, Date fechaRegistro) {
        this.idRol = idRol;
        this.nombre = nombre;
        this.estado = estado;
