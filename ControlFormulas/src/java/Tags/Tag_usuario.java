            ...
            if (pageContext.getRequest().getAttribute("Usuario") != null) {
                if (pageContext.getRequest().getAttribute("Usuario").toString().equals("Registro")) {
                    ...
                    if (filtro == null ? "" == null : filtro.equals("")) {
                        out.print("<form action='Usuario?opc=1' method='post'>");
                        out.print("<div style='float: right;; margin: 20px;'><input type='text' name='fto' id='fto' placeholder='Buscar' onkeyup='javascript:this.value=this.value.toUpperCase();'/></div>");
                        out.print("</form>");
                    } else {
                        out.print("<form action='Usuario?opc=1' method='post'><div style='float: right; margin: 20px;'><input type='text' name='fto' id='fto' placeholder='Buscar' value='" + filtro + "' onkeyup='javascript:this.value=this.value.toUpperCase();'/></div></form>");
                    }
                    ...
                    for (int i = 0; i < lst_usuarios.size(); i++) {
                        ...
                        if (Integer.parseInt(obj_usuarios[6].toString()) == 1) {
                            ...
                            out.print("<td align='center'><a href='#' onclick='DesactivarUsuario(" + obj_usuarios[0] + ")'><img src='Interfaz/Contenido/Iconos/Check.png' width='30px' height='30px' alt='edit' title='Desactivar Usuario' /></a></td>");
                            out.print("<td align='center'><a href='Usuario?opc=3&Id_usuario=" + obj_usuarios[0] + "'><img src='Interfaz/Contenido/Iconos/Edit.png' width='26px' height='26px' alt='edit' title='Modificar Registro' /></a></td>");
                            out.print("</tr>");
                        } else {
                            ...
                            out.print("<td>" + obj_usuarios[4] + "</td>");
                            out.print("<td>" + obj_usuarios[8] + "</td>");
                            out.print("<td align='center'><a href='#' onclick='ActivarUsuario(" + obj_usuarios[0] + ")'><img src='Interfaz/Contenido/Iconos/Delete.png' width='26px' height='26px' alt='edit' title='Activar Usuario' /></a></td>");
                            out.print("<td align='center'><a href='Usuario?opc=3&Id_usuario=" + obj_usuarios[0] + "'><img src='Interfaz/Contenido/Iconos/Edit.png' width='26px' height='26px' alt='edit' title='Modificar Registro' /></a></td>");
                            out.print("</tr>");
                        }
                    }
                    ...
                    out.print("<div id='sidebar'>");
                    out.print("<div style='float: right;'><a href='Usuario?opc=1&fto='><img src='Interfaz/Contenido/Iconos/Delete.png' width='26px' height='26px' alt='edit' title='Cancelar Modificación' /></a></div>");
                    out.print("<h3>Modificar Usuario</h3>");
                    out.print("<form action='Usuario?opc=4' name='form1' method='post'>");
                    out.print("<b>Nombre(s) :</b>");
                    ...
                    out.print("<input type='text' name='Txt_usuario' id='Txt_usuario' placeholder='Usuario' title='Usuario' value='" + obj_usuario[5].toString().toUpperCase() + "' onchange='javascript:this.value=this.value.toUpperCase();'/>"
                            + "<script type='text/javascript'>var val1 = new LiveValidation('Txt_usuario');val1.add(Validate.Presence);</script>");
                    out.print("<input type='hidden' name='txt_passM' id='txt_passM'>");
                    List lst_rol = jpacrol.Roles();
                    out.print("<b>Rol :</b>");
                    out.print("<select name='Cbx_rol' id='Cbx_rol' title='Rol'>");
                    out.print("<option value='0' >Seleccionar Rol</option>");
                    ...
                    out.print("<div id='content'>");
                    if (filtro == null ? "" == null : filtro.equals("")) {
                        out.print("<form action='Usuario?opc=1' method='post'><div style='float: right;; margin: 20px;'><input type='text' name='fto' id='fto' placeholder='Buscar' onkeyup='javascript:this.value=this.value.toUpperCase();'/></div></form>");
                    } else {
                        out.print("<form action='Usuario?opc=1' method='post'><div style='float: right;; margin: 20px;'><input type='text' name='fto' id='fto' placeholder='Buscar' onkeyup='javascript:this.value=this.value.toUpperCase();' value='" + filtro + "'/></div></form>");
                    }
                    out.print("<h3>Usuarios</h3>");
                    out.print("<div align='left' id='NavPosicion'></div>");
                    out.print("<table id='resultados' class='table' style='width:100%'>");
