...
public class Tag_visor_plumat extends TagSupport {
...
//            String usuario = rol_usuario[1];
            ...
            //FIN VARIABLES
            if (pageContext.getRequest().getAttribute("Registro").toString().equals("Registro_visor_plumat")) {
                ...
                out.print("<td align='center' colspan='2'>"
                        ...
                        + "</td>");
                if (fecha_version_decimal >= 2016.0101) {
                    out.print("<td align='center' colspan='4'><h2 class='negro'>REGISTRO CONTROL PROCESO<hr /> <b>LINEA : </b>" + obj_registro[6] + " <b>FICHA TECNICA : </b>" + obj_registro[24] + " <b> VERSION : </b>" + obj_registro[25] + " <hr /><b>ORDEN DE PRODUCCION : </b>" + obj_registro[18] + " </h2></td>");
                } else {
...
// </editor-fold>
                ...
                if (obj_registro[65].toString().equals("R-PRF-056")) {
                    if (fecha_version_decimal >= 2025.0401) {
                        out.print("<td align='center' colspan='2'><h2 class='negro'>CODIGO <b>" + obj_registro[65] + "</b> <hr /> VERSION <b>8</b></h2></td>");
                    } else if (fecha_version_decimal >= 2024.0426 && fecha_version_decimal <= 2025.0331) {
                        out.print("<td align='center' colspan='2'><h2 class='negro'>CODIGO <b>" + obj_registro[65] + "</b> <hr /> VERSION <b>7</b></h2></td>");
                    } else if (fecha_version_decimal >= 2023.0901 && fecha_version_decimal <= 2024.0425) {
                        out.print("<td align='center' colspan='2'><h2 class='negro'>CODIGO <b>" + obj_registro[65] + "</b> <hr /> VERSION <b>6</b></h2></td>");
                    } else if (fecha_version_decimal >= 2022.0908) {
                        out.print("<td align='center' colspan='2'><h2 class='negro'>CODIGO <b>" + obj_registro[65] + "</b> <hr /> VERSION <b>5</b></h2></td>");
                    } else if (fecha_version_decimal >= 2020.0623 && fecha_version_decimal <= 2022.0907) {
                        out.print("<td align='center' colspan='2'><h2 class='negro'>CODIGO <b>" + obj_registro[65] + "</b> <hr /> VERSION <b>4</b></h2></td>");
                    } else if (fecha_version_decimal >= 2018.0521 && fecha_version_decimal <= 2020.0622) {
                        out.print("<td align='center' colspan='2'><h2 class='negro'>CODIGO <b>" + obj_registro[65] + "</b> <hr /> VERSION <b>3</b></h2></td>");
                    }
                }
                // </editor-fold>
                ...
                out.print("</tr>");
                out.print("<tr>");
                //<editor-fold defaultstate="collapsed" desc="CLIENTE / PRODUCTO / LOTE / VOLUMEN">
                out.print("<td align='center' colspan='2'><b>CLIENTE : </b>" + obj_registro[19] + "</td>");
                out.print("<td align='center' colspan='1'><b>PRODUCTO : </b>" + obj_registro[21] + "<b>/</b>" + obj_registro[22] + "</td>");
                out.print("<td align='center' colspan='2'><b>LOTE PRODUCTO:</b>" + obj_registro[3] + "</td>");
                out.print("<td align='center' colspan='2'><b> VOLUMEN : </b>" + obj_registro[23] + "</td>");
...
//</editor-fold>
                out.print("<tr>");
                out.print("<tr>");
                //<editor-fold defaultstate="collapsed" desc="MANGA C / P / LONGITUD CUERPO SELLADO +/-">
                out.print("<td align='center' colspan='2'><b>MANGA C : </b> " + obj_registro[7] + " </td>");
                out.print("<td align='center' colspan='2'><b> P : </b> " + obj_registro[8] + " </td>");
                out.print("<td align='center' colspan='4'><b> LONGITUD DE CUERPO SELLADO: </b> " + obj_registro[125] + " </td>");
                //</editor-fold>
                out.print("</tr>");
                out.print("<tr>");
                out.print("<td align='center' colspan='7'><b>DUCTO DERECHO </b> <b style='margin-left: 10px;'>C : </b> " + obj_registro[9] + " <b> P : </b> " + obj_registro[10] + " ");
                out.print("<b style='margin-left: 10px;'> LONGITUD : </b> " + ((obj_registro[126].toString().contains("null+/-null")) ? "N/A" : obj_registro[126]) + " ");
                out.print("<b style='margin-left: 100px;'>DUCTO IZQUIERDO</b> <b style='margin-left: 10px;'>C : </b> " + obj_registro[11] + "<b> P : </b> " + obj_registro[12] + " ");
                out.print("<b style='margin-left: 10px;'> LONGITUD : </b> " + ((obj_registro[127] == null) ? "N/A" : obj_registro[127]) + " </td>");
                out.print("</tr>");

                if (fecha_version_decimal >= 2025.0409) {
                    out.print("<tr>");
                    out.print("<td align='center' colspan='7'><b style='margin-left: 100px;'>DUCTO CENTRAL</b> <b style='margin-left: 10px;'>C : </b> " + obj_registro[79] + "<b> P : </b> " + obj_registro[80] + " ");
                    out.print("<b style='margin-left: 10px;'> LONGITUD : </b> " + ((obj_registro[128] == null) ? "N/A" : obj_registro[128]) + " </td>");
                    out.print("</td></tr>");
                }
                //</editor-fold>
                out.print("<tr>");
                //<editor-fold defaultstate="collapsed" desc="ENSAMBLE / LOTE / LOTE TINTA / COLOR TINTA /FECHA / TURNO">
                out.print("<td align='center' colspan='2'><b>ENSAMBLE: </b> " + obj_registro[13] + " </td>");
                out.print("<td align='center' colspan='1'><b>LOTE: </b> " + obj_registro[14] + " </td>");
                out.print("<td align='center' colspan='1'><b>LOTE TINTA: </b> " + obj_registro[15] + " </td>");
                out.print("<td align='center' colspan='1'><b>COLOR TINTA: </b> " + obj_registro[67] + " </td>");
                out.print("<td align='center' colspan='1'><b>FECHA: </b> " + obj_registro[2] + " </td>");
                out.print("<td align='center' colspan='1'><b>TURNO: </b> " + obj_registro[4] + " </td>");
                //</editor-fold>
                out.print("</tr>");
                out.print("</table>");
                // </editor-fold>
                ...
                if (lst_parametros == null) {
                    ...
                    out.print("<td style='background-color:#eee;height:330px'>"
                            + "<img src='Interfaz/Contenido/images/Linea.png' alt='Logo' style='width:1530px;height:330px' />");
...
//                //VERIFICACIÓN DE LOTE Y CODIGO
                ...
                if (lst_parametros == null) {
                    ...
                    out.print("<td style='background-color:#eee;height:100px'>"
                            + "<img src='Interfaz/Contenido/images/Linea.png' alt='Logo' style='width:1530px;height:100px' />");
////                            + "<b class='naranja'>No hay datos de parámetros de frecuencia por hora</b><br /><br /></td>");
                    out.print("</tr>");
                    out.print("</table>");
                } else {
...
//                // </editor-fold>
                ...
                if (lst_parametros == null) {
                    ...
                    out.print("<td style='background-color:#eee;height:150px'>"
                            + "<img src='Interfaz/Contenido/images/Linea.png' alt='Logo' style='width:1530px;height:150px' />");
////                            + "<b class='naranja'>No hay datos de parámetros de frecuencia por hora</b><br /><br /></td>");
                    out.print("</tr>");
                    out.print("</table>");
                        ...
                        if ((Integer) obj_parametros[4] == 1) {
                            ...
                            if (obj_parametros[5] == null) {
                                ...
                                if (arg_responsables[0].equals("Administrador")) {
                                    ...
                                    out.print("<td align='center' colspan='" + cols + "'><b class='coordinadora'>" + obj_parametros[12] + "</b></td>");
                                } else if (arg_responsables[0].equals("Inspectora-Calidad") || arg_responsables[0].equals("Coordinadora-Calidad")) {
                            ...
                            if (obj_parametros[6] == null) {
                                ...
                                if (arg_responsables[0].equals("Administrador")) {
                                    ...
                                    out.print("<td colspan='6' ='center'><b class='calidad'>" + obj_parametros[6] + "</b></td>");
                                }
                            }
                            if (obj_parametros[7] == null) {
                                out.print("<td colspan='6' align='center'><b></b></td>");
                            } else if (obj_parametros[7].equals("No cumple")) {
                                out.print("<td colspan='6' align='center'><b class='rojo'>" + obj_parametros[7] + "</b></td>");
                            } else {
                                String[] arg_responsables = obj_parametros[15].toString().split("/");
                                if (arg_responsables[0].equals("Administrador")) {
                                    out.print("<td colspan='6' align='center'><b>" + obj_parametros[7] + "</b></td>");
                                } else if (arg_responsables[0].equals("Encargada-operaria")) {
                                    out.print("<td colspan='6' align='center'>" + obj_parametros[7] + "</td>");
                                } else if (arg_responsables[0].equals("Coordinadora-Produccion")) {
                                    out.print("<td colspan='6' align='center'><b class='coordinadora'>" + obj_parametros[7] + "</b></td>");
                                } else if (arg_responsables[0].equals("Inspectora-Calidad") || arg_responsables[0].equals("Coordinadora-Calidad")) {
                                    out.print("<td colspan='6' align='center'><b class='calidad'>" + obj_parametros[7] + "</b></td>");
                                }
                            }
...
//                //FIN OBSERVACIONES
//                // </editor-fold>
                //<editor-fold defaultstate="collapsed" desc="GRUPO DE TRABAJO">
                lst_responsables = RegistroHraJpa.ConsultarResponsableRegistro(id_registro);
                if (lst_responsables == null) {
                    out.print("<table class='table' style='width:850px;'>");
                    out.print("<tr>");
                    out.print("<td ><b>GRUPO DE TRABAJO</b></td>");
                    out.print("</tr>");
                    out.print("<tr>");
                    out.print("<td style='background-color:#eee;height:100px'>"
                            + "<img src='Interfaz/Contenido/images/Linea.png' alt='Logo' style='width:680px;height:100px' /></td>");
                    out.print("</tr>");
                } else {
                    String[] arr_respon = {};
                    String[] arr_resp = {};
                    Object[] obj_respons = (Object[]) lst_responsables.get(0);
                    String responsa = obj_respons[1].toString();
                    if (responsa.contains(",")) {
                        arr_respon = responsa.split(",");
                    } else {
                        arr_resp = responsa.split("/");
                    }

                    out.print("<table class='table' style='width: 850px;text-align: center;'>");
                    out.print("<tr>");
                    out.print("<th>#</th>");
                    ...
                    out.print("</tr>");
                    if (responsa.contains(",")) {
                        for (int i = 0; i < arr_respon.length; i++) {
                            arr_resp = arr_respon[i].split("/");
                            out.print("<tr>");
                            int tem = i + 1;
                            out.print("<td>" + tem + "</td>");
                            out.print("<td>" + arr_resp[0] + "</td>");
                            out.print("<td>" + arr_resp[1] + "</td>");
                            out.print("</tr>");
                        }
                    } else {
                        out.print("<tr>");
...
//                    out.print("<b class='naranja'>No hay datos en paradas de maquina.</b><br /><br />");
                    ...
                    out.print("<table class='table' style='width:680px'>");
                    out.print("<tr>");
                    out.print("<td colspan='11'><b>Paradas de maquina</b></td>");
                    out.print("</tr>");
                    out.print("<tr>");
                ...
                if (lst_mantenimiento_consulta == null) {
                    out.print("<table class='table' style='width:680px;'>");
                    out.print("<tr>");
                    out.print("<td ><b>Paradas de mantenimiento</b></td>");
                    out.print("</tr>");
                    out.print("<tr>");
                    out.print("<td style='background-color:#eee;height:200px'>"
                            + "<img src='Interfaz/Contenido/images/Linea.png' alt='Logo' style='width:680px;height:200px' />");
////                            + "<b class='naranja'>No hay datos de parámetros de frecuencia por hora</b><br /><br /></td>");
                    ...
                    out.print("<table class='table' style='width: 680px;'>");
                    out.print("<tr>");
                    out.print("<th>Parada Mantenimiento</th>");
                    for (int i = 1; i <= 8; i++) {
                        out.print("<th>" + i + "</th>");
                    }
                    out.print("<th>Total</th>");
                ...
                out.print("<table class='table' style='width:680px;'>");
                out.print("<tr>");
                out.print("<td ><b>HORA MONTAJE INSUMOS</b></td>");
                out.print("</tr>");
                ...
                if (lst_hora_insumo != null) {
                    ...
                    out.print("</tr>");
                    out.print("<tr>");
//                    out.print("<td><b>CONSECUTIVO DUCTO</b></td>");
                    int irr = 0;
                    for (int i = 1; i < 9; i++) {
                        if (!hora_cons.equals("")) {
...
//                    out.print("<td> &nbsp;  </td>");
                    ...
                    if (!respons_iz.equals("")) {
                        out.print("<td rowspan='3' align='center' style='width: 20%;font-size: 8px; cursor:pointer;'>" + respons_iz + " </td>");
                    } else {
                        out.print("<td rowspan='3' align='center' style='width: 20%;font-size: 8px; cursor:pointer;'> Sin responsable </td>");
                    }
                    ...
                    if (!respons_dc.equals("")) {
                        out.print("<td rowspan='3' align='center' style='width: 20%;font-size: 8px; cursor:pointer;'>" + respons_dc + " </td>");
                    } else {
                        out.print("<td rowspan='3' align='center' style='width: 20%;font-size: 8px; cursor:pointer;'> Sin responsable </td>");
                    }
                    out.print("</tr>");
            ...
            Logger.getLogger(Tag_visor_plumat.class.getName()).log(Level.SEVERE, null, ex);
        }
