...
@NamedQueries({
    ...
    @NamedQuery(name = "Serial.findByFechaCalibracion", query = "SELECT s FROM Serial s WHERE s.fechaCalibracion = :fechaCalibracion"),
    @NamedQuery(name = "Serial.findByFechaProximaCalibracion", query = "SELECT s FROM Serial s WHERE s.fechaProximaCalibracion = :fechaProximaCalibracion"),
