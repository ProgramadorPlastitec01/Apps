...
var Validate = {
    ...
    aphaNum: function (value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        Validate.Format(valor, {
            failureMessage: mensaje,
            pattern: /^[0-9a-zA-Z]*$/i
        });
        return true;
    },
    ...
    Ficha_tecnica_eva: function (value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        Validate.Format(value, {
            failureMessage: message,
            pattern: /^FT-[DTE]{1,2}-[0-9]{3,4}$/i
        });
        return true;
    },
    ...
    LoteXN: function (value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        if (value == "N/A") {
            Validate.Format(value, {
    ...
    ValorHora: function (value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        if (value == "N/A") {
            Validate.Format(value, {
    ...
    ValorTexto: function (value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        if (value == "N/A") {
            Validate.Format(value, {
    ...
    Parametros_maximosPlumatt: function (value, paramsObj) {
        if (!paramsObj.match) {
            throw new Error("Validate::Confirmation - Error validating confirmation: Id of element to match must be provided!");
        }
        var paramsObj = paramsObj || {};
        ...
        // Permitir cero y verificar si el valor está dentro del rango tolerado
        if (valor !== 0 && valor > desviacion) {
            Validate.fail(message);
        }
        return true;
    },
    ...
    Parametros_minimosPlumatt: function (value, paramsObj) {
        if (!paramsObj.match) {
            throw new Error("Validate::Confirmation - Error validating confirmation: Id of element to match must be provided!");
        }
        var paramsObj = paramsObj || {};
        ...
        // Permitir cero y verificar si el valor está dentro del rango tolerado
        if (valor !== 0 && valor < (desviacion - 0.001)) {
            Validate.fail(message);
        }
        return true;
    },
