...
//        LocalDate today = LocalDate.now();
        ...
        try {
            if (idShift > 0) {
                ...
                String[] Shiftids = {};
                String ShiftAll = "";
                String UserIn = "", shiftOne = "", shiftTwo = "", shiftThree = "", shiftFour = "", shiftFive = "", shiftSix = "", shiftSeven = "", shiftEight = "";
                if (lst_shift2 != null) {
                ...
                out.print("<h4 class='text-center'>Turno</h4>");
                ...
                if (lst_user != null || lst_user.size() > 0) {
                    for (int i = 0; i < lst_user.size(); i++) {
                        ...
                        out.print("<img alt='image' class='mr-3 rounded-circle' width='45' src='Interface/Photos/" + ObjUser[1] + ".jpg'>");
                        out.print("<div class='media-body'>");
...
////</editor-fold>
            ...
            out.print("<div class='col-lg-12 text-center' data-toggle='tooltip' data-placemente='top' title=''>");
            out.print("<h4>Seleccionar semana</h4>");
            out.print("<select class='form-control col-lg-6' name='weekSelect' style='margin-top: 12px; margin-bottom: 12px; margin: auto;'  onchange=\"moveWeekAct(this.value)\">");
