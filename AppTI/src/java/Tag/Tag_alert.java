...
//</editor-fold>
            ...
            if (pageContext.getRequest().getAttribute("RegisterTemplate") != null) {
                boolean result = Boolean.valueOf(pageContext.getRequest().getAttribute("RegisterTemplate").toString());
                if (result) {
                    out.print("<script type='text/javascript'>");
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
            ...
            if (pageContext.getRequest().getAttribute("UpdateTemplateState") != null) {
                boolean result = Boolean.valueOf(pageContext.getRequest().getAttribute("UpdateTemplateState").toString());
                if (result) {
                    out.print("<script type='text/javascript'>");
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
                            + "    title: 'Correcto',\n"
                            + "    message: 'Se ha realizado acambio de estado.',\n"
                            + "    position: 'bottomRight'\n"
                            + "  });\n"
                            + "});");
                    out.print("</script>");
            ...
            if (pageContext.getRequest().getAttribute("RegisterDevice") != null) {
                ...
                if (result) {
                    ...
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
                            + "    title: 'Correcto',\n"
                            + "    message: 'Se registro el dispositivo correctamente.',\n"
                            + "    position: 'bottomRight'\n"
                            + "  });\n"
                            + "});");
                    out.print("</script>");
            ...
            if (pageContext.getRequest().getAttribute("DeviceHeaderReg") != null) {
                ...
                if (result) {
                    ...
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
                            + "    title: 'Correcto',\n"
                            + "    message: 'Se registro el evento correctamente.',\n"
                            + "    position: 'bottomRight'\n"
                            + "  });\n"
                            + "});");
                    out.print("</script>");
