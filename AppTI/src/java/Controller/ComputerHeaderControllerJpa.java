...
public class ComputerHeaderControllerJpa {
    ...
    public boolean AddCalificationComputerHeader(int idH) {
        EntityManager em = getEntityManager();
        em.getTransaction().begin();
        try {
            Query q = em.createNativeQuery("CALL `Sp_chd_u_AddCalificationComputerHead`(" + idH + ")");
            int resultado = q.executeUpdate();
            em.getTransaction().commit();
            em.clear();
            em.close();
    ...
    public boolean UpdateDataComputer(int idPc, String Respo, int idArea, String position) {
        EntityManager em = getEntityManager();
        em.getTransaction().begin();
        try {
            Query q = em.createNativeQuery("CALL `Sp_chd_u_UpdateDataComputer`(" + idPc + ", '" + Respo + "', " + idArea + ", '" + position + "')");
            int resultado = q.executeUpdate();
            em.getTransaction().commit();
            em.clear();
            em.close();
