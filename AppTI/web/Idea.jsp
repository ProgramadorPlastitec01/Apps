...
<%@taglib uri="/WEB-INF/tlds/Tld_idea.tld" prefix="Idea" %>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <script>
            function ValidationSave(data) {
                document.getElementById("validation").value = data;
                const myForm = document.getElementById('FormIdea');
                myForm.submit(); // aquí estaba el error
            }
        </script>
