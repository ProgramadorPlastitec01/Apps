...
<html lang="es">
    ...
    <body>
        ...
        <main class="wrap" role="main" aria-labelledby="title400">
            <section class="content" aria-label="Información error">
                <h1 id="title400" class="code404" data-text="400">400</h1>

                <div class="subtitle">Solicitud incorrecta</div>

                <p class="description">
                    La petición enviada al servidor no es válida.<br>
        ...
        <p class="sr-only">Error 400 - Solicitud incorrecta en NEXUS</p>
