            ...
            if (pageContext.getRequest().getAttribute("Usuario") != null) {
                if (pageContext.getRequest().getAttribute("Usuario").toString().equals("Modulo_usuario")) {
                    ...
                    if (id_usuario > 0) {
                        ...
                        out.print("<div align='right'><a href='Usuario?opc=1'><img src='Interfaz/Contenido/Iconos/Delete.png' width='26px' height='26px' alt='edit' title='Cancelar Modificación' /></a></div>");
                        ...
                        out.print("<input type='text' name='Txt_usuario' id='Txt_usuario' placeholder='Usuario' title='Usuario' value='" + obj_usuario[6].toString().toUpperCase() + "' onchange='javascript:this.value=this.value.toUpperCase();'/>"
                        ...
                        out.print("<center><h3><br><a class='naranja' href='#' onclick=restablecePass('" + id_usuario + "')> Restablecer Contraseña </a></h3></center>");
                        out.print("</form>");
//</editor-fold>
                    } else {
