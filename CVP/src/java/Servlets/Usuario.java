        ...
        try {
            ...
            switch (opc) {
                ...
                case 2:
                    ...
                    proceso = jpacusa.Registrar_usuario(nombre, apellido, documento, codigo, usuario, id_rol, id_area, rol_usuario);
                    if (proceso) {
                ...
                case 3:
                    ...
                    id_rol = Integer.parseInt(request.getParameter("Cbx_rol").toString());
                    id_area = Integer.parseInt(request.getParameter("Cbx_area").toString());
                    proceso = jpacusa.Modificar_usuario(id_usuario, nombre, apellido, documento, codigo, usuario, id_rol, id_area);
                    if (proceso) {
                ...
                case 6:
                    try {
                        id_usuario = Integer.parseInt(request.getParameter("idUsuario").toString());
                    } catch (Exception e) {
                        id_usuario = 0;
                    }
                    try {
                        id_modificar = Integer.parseInt(request.getParameter("idUsuarioM").toString());
                    } catch (Exception e) {
                        id_modificar = 0;
                    }
                    if (id_usuario != 0) {
                        proceso = jpacusa.RestablecerPass(id_usuario);
                    } else {
                        proceso = jpacusa.RestablecerPass(id_modificar);
                    }
                    if (proceso) {
