function Pager1(tableName_1, itemsPerPage_1) {
    ...
    this.showPage_1 = function (pageNumber_1) {
        ...
        newPageAnchor_1.style.color = '#007C2A';
    ...
    this.showPageNav_1 = function (pagerName_1, positionId_1) {
        ...
        var pagerHtml_1 = '<span onclick="' + pagerName_1 + '.first();" style="size:12px;" onmouseover="this.style.cursor=\'pointer\'"><i title="Primero" style="color:#007C2A;">Primero </i></span>';
        pagerHtml_1 += '<span onclick="' + pagerName_1 + '.prev();" class="pg-normal1" style="size:12px;font-family:Wingdings;" onmouseover="this.style.cursor=\'pointer\'"><i style="color:#007C2A;" title="Anterior">&#8920;</i></span> ';
        var divisor_1 = 1;
        var idDivisor_1 = 1;
        ...
        pagerHtml_1 += ' <span onclick="' + pagerName_1 + '.next();" class="pg-normal1" style="size:12px;font-family:Wingdings;" onmouseover="this.style.cursor=\'pointer\'"><i style="color:#007C2A;" title="Siguiente">&#8921;</i></span> ';
        pagerHtml_1 += '<span onclick="' + pagerName_1 + '.last();" style="size:12px;" onmouseover="this.style.cursor=\'pointer\'"><i title="Ultimo" style="color:#007C2A;"> Ultimo</i><i style="color:#007C2A;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total Paginas</i><i style="color:#007C2A;">(' + this.pages_1 + ')</i></span>';
