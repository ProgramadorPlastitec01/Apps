<%
            ...
            if (sesion.getAttribute("Id_usuario") != null || sesion.getAttribute("Nombres") != null || sesion.getAttribute("Codigo") != null || sesion.getAttribute("Usuario") != null || sesion.getAttribute("Password") != null
                    || sesion.getAttribute("Estado") != null || sesion.getAttribute("Id_rol") != null || sesion.getAttribute("Nombre_rol") != null || sesion.getAttribute("Fecha_registro") != null || sesion.getAttribute("Id/Area") != null
                ...
                sesion.removeAttribute("Id_area_user");
