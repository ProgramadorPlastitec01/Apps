...
<script type="text/javascript" src="Interfaz/Paginas/paging_1.js"></script>
<!--Acoordeon-->
...
<script type="text/javascript" language="javascript">
    ...
    function Imprimir_chart() {
        var contenedor = document.getElementById("chart").innerHTML;
        var frame = document.createElement("iframe");
        frame.name = "frame1";
        frame.style.position = "absolute";
        frame.style.top = "-1000000px";
        ...
        frameDoc.document.open();
        frameDoc.document.write('<html><head><title>Imprimir</title>');
        frameDoc.document.write('<link href="Interfaz/Mapa_conceptual/jOrgChart/jquery.jOrgChart.css" rel="stylesheet" type="text/css"/>');
        frameDoc.document.write('</head><body>');
        frameDoc.document.write(contenedor);
        frameDoc.document.write('</body></html>');
        frameDoc.document.close();
    ...
    function restablecePass(id_Usuario) {
        swal({
            ...
            confirmButtonColor: "#007C2A",
            confirmButtonText: "Aceptar",
            cancelButtonText: "Cancelar",
            closeOnConfirm: false
        },
                function () {
                    location.href = 'Usuario?opc=6&idUsuario=' + id_Usuario + '';
                });
    }
</script>
<!--Excel-->
