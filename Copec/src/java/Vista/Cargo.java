...
//                    out.print("</tr>");
                    ...
                    out.print("</tr>");
                    out.print("<tr>");
                    out.print("<td colspan='3' style='    text-align: center;\n"
                            + "    font-size: 10px;\n"
                            + "    background-color: #f9f9f9;\n"
                            + "    font-style: italic;' >La información personal en este documento será tratada y protegida de acuerdo con nuestras políticas de protección de datos personales.</td>");
                    out.print("</tr>");
                    out.print("</table>");
                    out.print("</div>");
                } else {
