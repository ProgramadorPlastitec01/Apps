...
public class Area implements Serializable {
    ...
    @OneToMany(mappedBy = "idArea")
    private Collection<Reportante> reportanteCollection;
    ...
    @XmlTransient
    public Collection<Reportante> getReportanteCollection() {
        return reportanteCollection;
    }

    public void setReportanteCollection(Collection<Reportante> reportanteCollection) {
        this.reportanteCollection = reportanteCollection;
    }
