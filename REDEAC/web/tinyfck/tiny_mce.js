...
TinyMCE_Control.prototype = {
    ...
    _onAdd: function (replace_element, form_element_name, target_document) {
        ...
        if (dynamicIFrame) {
            var html = tinyMCE.getParam('doctype') + '<html><head xmlns="http://www.w3.org/1999/xhtml"><base href="' + tinyMCE.settings['base_href'] + '" /><title>blank_page</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body  name="HTML_Editor" contenteditable="true" spellcheck="true"><div contenteditable="true"></div></body></html>';
            try {
                if (!this.isHidden())
                    this.getDoc().designMode = "on";
                doc.open();
