...
<%
    ...
    String area = (String) sesion.getAttribute("Area").toString();
%>
<html>
    <head>
        ...
        <script language="javascript">
            ...
            window.onload = function ()
            {
                ...
                var area = "<%=area%>"; 
                if (area === '1') {
                    window.OpenFolder('/SISTEMAS/');
                }else if (area === '2') {
                    window.OpenFolder('/LOGISTICA/');
                }else if (area === '3') {
                    window.OpenFolder('/MANTENIMIENTO INSUMOS/');
                }else if (area === '4') {
                    window.OpenFolder('/PRODUCCION INSUMOS/');
                }else if (area === '5') {
                    window.OpenFolder('/PROYECTOS/');
                }else if (area === '6') {
                    window.OpenFolder('/MANTENIMIENTO GENERAL/');
                }else if (area === '7') {
                    window.OpenFolder('/PRODUCCIÓN FARMACEUTICA/');
                }
            }
        </script>
    </head>
