            ...
            if (ServletFileUpload.isMultipartContent(request)) {
                ...
                while (it.hasNext()) {
                    ...
                    if (fileItemTemp.isFormField()) {
                        ...
                        idC = Integer.parseInt(hidden.get(1).toString());
                ...
                result = actividad.RegistroActividad(hidden, file_name);
                request.getRequestDispatcher("Actividad?op=2&result=" + result + "").forward(request, response);
            }
%>