...
//            //String ruta = request.getParameter("ruta_proyecto").toString();
            ...
            String nombre_cargo = request.getParameter("nomC").toString();
            String nombre_area = request.getParameter("nomA").toString();
//            //String archivo = "\\\\172.16.2.117\\d\\Sistemas de informacion\\Dis_Desarrollo\\Adjuntos_proyectos\\" + ruta + nombre_archivo;
            String archivo = "\\\\172.16.2.117\\d\\Sistemas de informacion\\Bitacora_general\\Archivos_adjuntos\\" + nombre_area + "\\" + nombre_archivo;
