...
public class Tag_soporte extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        int idUsuario = 0, nroDoc = 0, idAreax = 0, idSupport = 0;
...
//</editor-fold>
        try {
            if (lst_support == null) {
                ...
                out.print("<button class='btn btn-outline-secondary' onclick='location.href=\"Soporte?opc=1\"' style='height: 30px;padding: 3px;width: 30px;'><i class='fas fa-times'></i></button>");
                out.print("</div>");
                out.print("<div class='cont_form_user'>");
                out.print("<form action='Soporte?opc=2' method='post' class='needs-validation' novalidate=''>");
...
//</editor-fold>
            ...
            out.print("</div>");
            out.print("<div class='cont_form_user'>");
            out.print("<form action='Soporte?opc=3' method='post' class='needs-validation' novalidate=''>");
...
//</editor-fold>
            if (idSupport > 0) {
                ...
                out.print("</div>");
                out.print("<div class='cont_form_user' style='    max-height: 509px;\n"
                        + "    height: 509px;\n"
                        + "    overflow-y: auto;'>");
                    ...
                    for (int i = 0; i < lst_support.size(); i++) {
                        ...
                        for (int j = 0; j < arr_case.length; j++) {
                            ...
                            if (!obj_case[8].equals("N/A")) {
                                out.print("<div class='col-4'>");
                                out.print("<b>Estado: </b> <span class='text-success'>Solucionado</span>");
                                out.print("</div>");
                                out.print("</div>");
...
//</editor-fold>
            ...
            out.print("<button class='btn btn-white' style='border-radius: 4px;margin-right: 12px;' data-toggle='tooltip' data-placement='top' title='Recargar' onclick='location.href=\"Soporte?opc=1\"'><i class=\"fas fa-sync-alt\"></i></button>");
            out.print("<button class='btn btn-primary' style='border-radius: 4px;' data-toggle='tooltip' data-placement='top' title='Registrar Caso' onclick='mostrarConvencion(1)'><i class='fas fa-plus'></i></button>");
            out.print("</div>");
            out.print("</div>");
                        ...
                        for (int j = 0; j < arr_case.length; j++) {
                            ...
                            if (!obj_case[8].equals("N/A")) {
                                ...
                                if (Integer.parseInt(obj_case[19].toString()) == 0) {
                                    out.print("<a class='btn btn-warning' data-toggle='tooltip' data-placement='top' title='Solucionado sin calificar' href='Soporte?opc=1&idSupport=" + idTemp + "'><i class='fas fa-check'></i></a>");
                                } else {
                                    out.print("<a class='btn btn-success' data-toggle='tooltip' data-placement='top' title='Cerrado' href='Soporte?opc=1&idSupport=" + idTemp + "'><i class='fas fa-check'></i></a>");
                                }
                                out.print("</td>");
                            } else {
                                out.print("<td> Esperando... </td>");
                                out.print("<td> Solucion... </td>");
                                out.print("<td align='center'> <a class='btn btn-info' data-toggle='tooltip' data-placement='top' title='Esperando solucion' href='Soporte?opc=1&idSupport=" + idTemp + "'><i class=\"fas fa-hourglass-start fa-spin\" ></i></a> </td>");
                            }
                            out.print("</tr>");
                            j = arr_case.length;
                        }
            ...
            Logger.getLogger(Tag_soporte.class.getName()).log(Level.SEVERE, null, ex);
        }
