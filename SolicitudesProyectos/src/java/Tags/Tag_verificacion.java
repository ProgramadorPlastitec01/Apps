...
public class Tag_verificacion extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            try {
                IdEstandar = Integer.parseInt(this.pageContext.getRequest().getAttribute("IdEstandar").toString());
            } catch (NumberFormatException e) {
                IdEstandar = 0;
            }
            if (id_pieza == 0) {
                ...
                if (id_verificacion == 0) {
                    ...
                    if (lst_calificacion != null || lst_verificacion != null) {
                        ...
                        LocalDate fechaV1 = LocalDate.of(2026, 3, 4);
                        LocalDate fechaV2 = LocalDate.of(2025, 5, 14);
                ...
                if (lst_electrodo != null) {
                    ...
                    out.print("<h1>Modulo Verificación</h1>");
                    out.print("<button class=\"btn btn-red\" style=\"border-radius: 4px;\" data-toggle=\"tooltip\" data-placement=\"top\" onclick=\"location.href='Verificacion?opc=4&idP=" + id_plano + "&numS=" + numSolicitud + "&id_pieza=" + id_pieza + "&IdEstandar=1'\" title=\"VerificaciEstandar\"><i class=\"fas fa-sync-alt\"></i></button>");
                    out.print("</div>");
                    out.print("<div class='section-body'>");
                    out.print("<div class='row'>");
                    out.print("<div class='col-12'>");
                    ...
                    if (IdEstandar == 0) {
                        ...
                        if (lst_verificacionEtd != null) {
                            ...
                            for (int i = 0; i < lst_verificacionEtd.size(); i++) {
                                ...
                                out.print("<td><select class='form-control' name='txtcumple_" + i + "'  id='select-id' required>");
                                out.print("<option value='NO'>NO</option>");
                                out.print("<option value='SIR'>SI</option>");
                                out.print("</select>");
                                out.print("<td><select class='form-control' name='txtaplica_" + i + "'  id='select-id' required>");
                                out.print("<option value='NO'>NO</option>");
                                out.print("<option value='SIR'>SI</option>");
                                out.print("</select>");
                                out.print("<td><textarea  style='height:44px!important' class='form-control' name='txtobservaciones_" + i + "' placeholder='Observaciones' onchange='javascript:this.value=this.value.toUpperCase();'></textarea></td>");
