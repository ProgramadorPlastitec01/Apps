...
<%@taglib uri="/WEB-INF/tlds/plano.tld" prefix="Plano" %>
            ...
            <div class="main-wrapper main-wrapper-1">
                ...
                <script type="text/javascript" language="javascript">
                    function mostrarPlano(id) {
                        if (document.getElementById("Plano" + id).style.display === "none") {
                            document.getElementById("Plano" + id).style.display = "block";
                        } else if (document.getElementById("Plano" + id).style.display === "block") {
                            document.getElementById("Plano" + id).style.display = "none";
                        }
                    }
                </script>
            </div>
