    ...
    $.extend($.fn, {
        ...
        treeview: function(settings) {
            ...
            function toggler() {
                ...
                .find(">.hitarea")
                .swapClass( CLASSES.expandableHitarea, CLASSES.collapsableHitarea )
                .swapClass( CLASSES.lastExpandableHitarea,CLASSES.lastCollapsableHitarea )
                .end()
                ...
                case "location":
                    ...
                    if ( current.length ) {
                        ...
                        if (settings.prerendered) {
                            ...
                            items.filter("li")
                            .swapClass( CLASSES.expandable,CLASSES.collapsable )
                            .swapClass( CLASSES.lastExpandabl,CLASSES.lastCollapsablee )
                            .find(">.hitarea")
                            .swapClass( CLASSES.expandableHitarea,CLASSES.collapsableHitarea )
                            .swapClass( CLASSES.lastExpandableHitarea,CLASSES.lastCollapsableHitarea );
                        }
