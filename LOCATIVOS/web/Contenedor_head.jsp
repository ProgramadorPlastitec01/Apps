...
<script type="text/javascript" language="javascript">
    function Imprimir_cartas(obj_id_empresas) {
        var objeto = document.getElementById('Imprimir' + obj_id_empresas);
        var ventana = window.open('', '_blank');
        ventana.document.write(objeto.innerHTML);
        ventana.document.write('<link href="Interfaz/Contenido/Css/CSS_Principal.css" rel="stylesheet" type="text/css"/>');
...
<!--Arbol-->
<link rel="stylesheet" href="Interfaz/Arbol/jquery.treeview.css" type="text/css"/>
