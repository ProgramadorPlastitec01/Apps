...
//FECHA
            ...
            String mes = "";
            if ((cal.get(Calendar.MONTH) + 91) < 10) {
            ...
            if (ServletFileUpload.isMultipartContent(request)) {
                    ...
                    if (fileItemTemp.isFormField()) {
                        ...
                        try {
                            if (fileItem.getSize() != 0) {
                                ...
                                String dir_name = "\\\\172.16.2.122\\d\\Sistemas de informacion\\Locativos\\Adjuntos_anexos\\";
                                ...
                                id_origen = Integer.parseInt(hidden.get(0).toString());
                                request.getRequestDispatcher("Programacion?opc=7&Id_origen=" + id_origen ).forward(request, response);
                                break;
                            }
                        } catch (Exception e) {
                            request.getRequestDispatcher("Programacion?opc=1").forward(request, response);
                            break;
                        }
                    }
                ...
                id_origen = Integer.parseInt(hidden.get(0).toString());
                request.getRequestDispatcher("Programacion?opc=19&Id_origen=" + id_origen + "&file_name=" + file_name).forward(request, response);
            }
%>