        ...
        try {
            ...
            switch (opc) {
                case 1:
                    ...
                    if (lst_usuario == null) {
                        ...
                        if ((Integer) obj_sesion[5] == 0) {
                            ...
                            sesion.setAttribute("Nombre_rol_old", "N/A");
                            sesion.setAttribute("Fecha_registro", obj_sesion[8]);
                            sesion.setAttribute("Id_area", obj_sesion[9]);
                            sesion.setAttribute("Correo", obj_sesion[10]);
                ...
                case 3:
                    ...
                    break;
                case 4:
                    caso_rol = Integer.parseInt(request.getParameter("crl").toString());
                    sesion.removeAttribute("Nombre_rol");
                    sesion.removeAttribute("Nombre_rol_old");
                    if (caso_rol == 1) {
                        sesion.setAttribute("Nombre_rol", "Ejecutor");
                        sesion.setAttribute("Nombre_rol_old", "Programador");
                    } else {
                        sesion.setAttribute("Nombre_rol", "Programador");
                        sesion.setAttribute("Nombre_rol_old", "Ejecutor");
                    }
                    request.getRequestDispatcher("Inicio.jsp").forward(request, response);
                    break;
            }
