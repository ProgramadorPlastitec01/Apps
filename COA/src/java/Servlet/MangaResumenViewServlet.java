...
/**
 * Sirve la página HTML del Resumen Estadístico de Inspección Manga para un
 * orden/lote, para que FileManager.jsp pueda mostrarlo ("Ver original") y
 ...
 * unificado completo.
 */
@WebServlet("/MangaResumenViewServlet")
public class MangaResumenViewServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            BatchRecordManifest.MangaResult resultado = BatchRecordManifest.consultarInspeccionManga(orden, lote);
            ...
            if (doc == null || doc.get("html") == null) {
                String motivo = resultado.diagnostico != null ? resultado.diagnostico
                        : "No hay Resumen Estadístico de Inspección Manga para este lote.";
            ...
            getServletContext().log("Error consultando Resumen Estadístico de Inspección Manga", ex);
