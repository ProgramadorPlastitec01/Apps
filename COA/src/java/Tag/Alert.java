...
//</editor-fold>
            ...
            if (pageContext.getRequest().getAttribute("UpdateProfile") != null) {
                ...
                if (result) {
                    ...
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
                            + "    title: 'Correcto',\n"
                            + "    message: 'Se ha modifico el perfil correctamente.',\n"
                            + "    position: 'bottomRight'\n"
                            + "  });\n"
                            + "});");
                    out.print("</script>");
            ...
            if (pageContext.getRequest().getAttribute("SignatureUpdate") != null) {
                boolean result = Boolean.valueOf(pageContext.getRequest().getAttribute("SignatureUpdate").toString());
                if (result) {
                    out.print("<script type='text/javascript'>");
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
                            + "    title: 'Correcto',\n"
                            + "    message: 'Se ha actualizado la firma correctamente.',\n"
                            + "    position: 'bottomRight'\n"
                            + "  });\n"
                            + "});");
                    out.print("</script>");
...
//</editor-fold>
            //<editor-fold defaultstate="collapsed" desc="REVISION">
            if (pageContext.getRequest().getAttribute("SigMasive") != null) {
                boolean result = Boolean.valueOf(pageContext.getRequest().getAttribute("SigMasive").toString());
                if (result) {
                    out.print("<script type='text/javascript'>");
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
                            + "    title: 'Correcto',\n"
                            + "    message: 'Se firmaron los certificados masivamente.',\n"
                            + "    position: 'bottomRight'\n"
                            + "  });\n"
                            + "});");
                    out.print("</script>");
            ...
            if (pageContext.getRequest().getAttribute("SigUnique") != null) {
                boolean result = Boolean.valueOf(pageContext.getRequest().getAttribute("SigUnique").toString());
                if (result) {
                    out.print("<script type='text/javascript'>");
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
                            + "    title: 'Correcto',\n"
                            + "    message: 'Se firmo el certificados correctamente.',\n"
                            + "    position: 'bottomRight'\n"
                            + "  });\n"
                            + "});");
                    out.print("</script>");
            ...
            if (pageContext.getRequest().getAttribute("UpdateCustomerState") != null) {
                boolean result = Boolean.valueOf(pageContext.getRequest().getAttribute("UpdateCustomerState").toString());
                if (result) {
                    out.print("<script type='text/javascript'>");
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
            ...
            if (pageContext.getRequest().getAttribute("UpdateCode") != null) {
                boolean result = Boolean.valueOf(pageContext.getRequest().getAttribute("UpdateCode").toString());
                if (result) {
                    out.print("<script type='text/javascript'>");
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
                            + "    title: 'Correcto',\n"
                            + "    message: 'Se modifico el código correctamente.',\n"
                            + "    position: 'bottomRight'\n"
                            + "  });\n"
                            + "});");
                    out.print("</script>");
            ...
            if (pageContext.getRequest().getAttribute("RegisterCode") != null) {
                boolean result = Boolean.valueOf(pageContext.getRequest().getAttribute("RegisterCode").toString());
                if (result) {
                    out.print("<script type='text/javascript'>");
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
                            + "    title: 'Correcto',\n"
                            + "    message: 'Se registró el código correctamente.',\n"
                            + "    position: 'bottomRight'\n"
                            + "  });\n"
                            + "});");
                    out.print("</script>");
            ...
            if (pageContext.getRequest().getAttribute("UpdateCodeState") != null) {
                boolean result = Boolean.valueOf(pageContext.getRequest().getAttribute("UpdateCodeState").toString());
                if (result) {
                    out.print("<script type='text/javascript'>");
                    out.print("$(\"#toastr-2\").ready(function() {\n"
                            + "  iziToast.success({\n"
                            + "    title: 'Correcto',\n"
                            + "    message: 'Se actualizo el estado del código correctamente.',\n"
                            + "    position: 'bottomRight'\n"
                            + "  });\n"
                            + "});");
                    out.print("</script>");
