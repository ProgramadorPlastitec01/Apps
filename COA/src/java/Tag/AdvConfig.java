...
public class AdvConfig extends TagSupport {
...
//</editor-fold>
            ...
            if (lst_setting != null) {
                ...
                for (int i = 0; i < lst_setting.size(); i++) {
                    ...
                    out.print("<div class='d-flex justify-content-around'>");
                    if (state == 1) {
                        out.print("<a class='btn btn-success btn-sm mr-2' href='AdvConfig?opt=3&idSett=" + Objset[0] + "&state=0' onclick='cargarDatos()'><i class='fas fa-check'></i></a>");
                    } else {
                        out.print("<a class='btn btn-danger btn-sm mr-2' href='AdvConfig?opt=3&idSett=" + Objset[0] + "&state=1' onclick='cargarDatos()'><i class='fas fa-times'></i></a>");
                    }
        ...
        //</editor-fold>
            ...
            Logger.getLogger(AdvConfig.class.getName()).log(Level.SEVERE, null, ex);
        }
