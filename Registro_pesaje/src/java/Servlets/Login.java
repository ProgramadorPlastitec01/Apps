...
//                            sesion.setAttribute("Codigo", obj_sesion[3]);
                                ...
                                sesion.setAttribute("NombreRol", obj_sesion[8]);
                                sesion.setAttribute("Nombre", obj_sesion[10]);
                                sesion.setAttribute("Apellido", obj_sesion[11]);
                                sesion.setAttribute("NombreCompleto", obj_sesion[1]);
//                            sesion.setAttribute("Area", obj_sesion[10]);
                                sesion.setAttribute("Estado", obj_sesion[7]);
