...
<%
    ...
    if (ServletFileUpload.isMultipartContent(request)) {
        ...
        int TypeSign = Integer.parseInt(hidden.get(1).toString());
        int idUser = Integer.parseInt(hidden.get(2).toString());
//        String Format = hidden.get(3).toString();

        request.getRequestDispatcher("Document?opt=3&IdDoc=" + IdDoc + "&IdUser=" + idUser + "&TypeSig=" + TypeSign + "&TxtSignatureImg=" + file_name + "").forward(request, response);
    }
%>
