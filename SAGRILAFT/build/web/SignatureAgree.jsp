...
<%
    ...
    if (ServletFileUpload.isMultipartContent(request)) {
        ...
        String NroDO = hidden.get(1).toString();
        String TypeSig = hidden.get(2).toString();
        String NmbSigna = hidden.get(3).toString();
        String Format = hidden.get(4).toString();
        String ReadDoc = hidden.get(4).toString();
        String Validation = hidden.get(5).toString();

        request.getRequestDispatcher("ClientSection?opt=13&IdDoc=" + IdDoc + "&TxtValidAction=" + Validation + "&Txt_ReadDoc=" + ReadDoc + "&TypeSig=" + TypeSig + "&NmbDocx=" + NroDO + "&NbmIdSigna=" + NmbSigna + "&TxtSignatureImg=" + file_name + "").forward(request, response);
    }
%>
