...
public class Tag_ClientSection extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        String ButtonSave = "", ButtonAd = "", ButtonSaveDisabled = "", ButtonSaveDisDoc = "", AdviceOne = "", adviceAttach = "";
//</editor-fold>
        ...
        try {
            if (IdDOc > 0) {
                ...
                if (lst_document != null) {
                    ...
                    AdviceOne = bundle.getString("form.adviceOne");
...
//                                String[] form = TemplForm[estTl].replace("][", "///").replace("[", "").replace("]", "").split("///");
                                ...
                                if (information) {
                                    ...
                                    for (int i = 1; i < form.length; i++) {
                                        ...
                                        out.print("</select>");
                                        out.print("</div>");
                                        out.print("<input type='text' class='form-control col-lg-8' name='NmbNroDoc" + validate + "' id='' placeholder='Numero de documento' value='" + DataForm[2] + "' data-toggle='tooltip' data-placement='top' title='' required>");
                                        out.print("</div>");
                                        out.print("</div>");
                                    ...
                                    out.print("</select>");
                                    out.print("</div>");
                                    out.print("<input type='text' class='form-control col-lg-8' name='NmbNroDoc' id=''  required>");
                                    out.print("</div>");
                                    out.print("</div>");
                                    out.print("<div class='col-lg-2'>");
                                    out.print("<div class='mt-4'>");
...
//                                    form = TemplForm[estTl].replace("][", "///").replace("[", "").replace("]", "").split("///");
                                ...
                                if (information) {
                                    ...
                                    for (int i = 1; i < formAcc.length; i++) {
                                        ...
                                        out.print("</select>");
                                        out.print("</div>");
                                        out.print("<input type='text' class='form-control col-lg-9' name='NmbNroDoc" + validateAcc + "Acc' id='' placeholder='Numero de documento' value='" + DataForm[2] + "' data-toggle='tooltip' data-placement='top' title='' required>");
                                        out.print("</div>");
                                        out.print("</div>");
                                        out.print("<div class='col-lg-2'>");
                                        out.print("<div class='text-center mt-4'>");
                                ...
                                if (information) {
                                    ...
                                    for (int i = 0; i < formBenf.length; i++) {
                                        ...
                                        out.print("</select>");
                                        out.print("</div>");
                                        out.print("<input type='text' class='form-control col-lg-9' name='NmbNroDoc" + validateBenf + "' id='NmbNroDoc' value='" + DataForm[2] + "' placeholder='Numero documento' data-toggle='tooltip' data-placement='top' title='' required>");
                                        out.print("</div>");
                                        out.print("</div>");
                                        out.print("<div class='col-lg-2'>");
                                        out.print("<div class='text-center mt-4'>");
...
//                                out.print("<input type='hidden' class='form-control' name='TxtFormat' value='" + Format + "'>");
                                ...
                                adviceAttach = bundle.getString("formO.advice");
                                ...
                                out.print("<div class=''>");
                                out.print(AdviceOne);
                                out.print("<br><span style='font-weight: bold;color: #ef5409;'>* "+ adviceAttach +"</span>");
                                out.print("</div>");
                                out.print("<div class=''>");
...
//                                //</editor-fold>
                                ...
                                out.print("</div>");
                                out.print("<div class='mt-2'>");
                                out.print("<input type='text' class='form-control' name='NmbDocx' id='NmbDocument' placeholder='Numero de documento' value='" + (information ? ((form[2].toString().equals("N/A")) ? "" : form[2].toString()) : "") + "' required>");
                                out.print("</div>");
                                out.print("</div>");
                                out.print("</div>");
...
//</editor-fold>
                            ...
                            adviceAttach = bundle_due.getString("form.adviceAttach");
...
//                                String[] form = TemplForm[estTl].replace("][", "///").replace("[", "").replace("]", "").split("///");
                                ...
                                out.print("<input type='text' class='form-control' name='NmbIdManager' id='' placeholder='Number' value='" + (information ? form[2] : "") + "' required>");
                                out.print("</div>");

                                out.print("<div class='col-lg-3'>");
                                out.print("<span class=''>" + SectionTwo + "</span>");
                                out.print("<input type='text' class='form-control' name='TxtEmailManager' id='' placeholder='email@address' value='" + (information ? form[3] : "") + "' required>");
                                out.print("</div>");
                                out.print("</div>");
                                ...
                                out.print("<div class='col-lg-3'>");
                                out.print("<span class=''>ID</span>");
                                out.print("<input type='text' class='form-control' name='NmbIdComercial' id='' placeholder='Number' value='" + (information ? form[5] : "") + "' required>");
                                out.print("</div>");

                                out.print("<div class='col-lg-3'>");
                                out.print("<span class=''>" + SectionTwo + "</span>");
                                out.print("<input type='text' class='form-control' name='TxtEmailComercial' id='' placeholder='email@address' value='" + (information ? form[6] : "") + "' required>");
                                out.print("</div>");
                                out.print("</div>");
                                ...
                                out.print("<div class='col-lg-3'>");
                                out.print("<span class=''>ID</span>");
                                out.print("<input type='text' class='form-control' name='NmbIdContac' id='' placeholder='Number' value='" + (information ? form[8] : "") + "' required>");
                                out.print("</div>");

                                out.print("<div class='col-lg-3'>");
                                out.print("<span class=''>" + SectionTwo + "</span>");
                                out.print("<input type='text' class='form-control' name='TxtEmailContac' id='' placeholder='email@address' value='" + (information ? form[9] : "") + "' required>");
                                out.print("</div>");
                                out.print("</div>");
                                ...
                                out.print("<div class='col-lg-3'>");
                                out.print("<span class=''>ID</span>");
                                out.print("<input type='text' class='form-control' name='NmbIdPayment' id='' placeholder='Number' value='" + (information ? form[11] : "") + "' required>");
                                out.print("</div>");

                                out.print("<div class='col-lg-3'>");
                                out.print("<span class=''>" + SectionTwo + "</span>");
                                out.print("<input type='text' class='form-control' name='TxtEmailPayment' id='' placeholder='email@address' value='" + (information ? form[12] : "") + "' required>");
                                out.print("</div>");
                                out.print("</div>");
                                ...
                                if (information) {
                                    out.print("<input type='" + (!form[2].equals("Savings") && !form[2].equals("Current") ? "text" : "hidden") + "' "
                                            + "class='form-control' name='txtOtherOne' id='idOtherOne' placholder='Response' "
                                            + "value='" + (!form[2].equals("Savings") && !form[2].equals("Current") ? form[2] : "") + "'>");
                                } else {
                                    out.print("<input type='hidden' class='form-control' name='txtOtherOne' id='idOtherOne' placholder='Response' value=''>");
                                }
...
//                                    out.print("<input type='hidden' class='form-control' name='TxtFormat' value='" + Format + "'>");
                                ...
                                try {
                                    String[] infoclien = TemplForm[1].replace("][", "///").replace("[", "").replace("]", "").split("///");
                                    nameCompany = infoclien[1].toString();
                                    Website = infoclien[8].toString();
                                } catch (Exception e) {
                                    nameCompany = "Agente de carga";
