...
<%@taglib uri="/WEB-INF/tlds/tld_Setting.tld" prefix="Setting" %>
<%@taglib uri="/WEB-INF/tlds/tld_alert.tld" prefix="tld_alert" %>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Configuración | SGLT</title>
    ...
    <body>
        <div id="app">
            ...
            <script type="text/javascript" >
                function ViewContentMail(id) {
                    if (document.getElementById("Content" + id).style.display === "none") {
                        document.getElementById("Content" + id).style.display = "block";
                    } else if (document.getElementById("Content" + id).style.display === "block") {
