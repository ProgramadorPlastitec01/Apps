...
function buscar(cadena) {
    ...
    document.getElementById('Tabla_resalta').innerHTML = document.getElementById('Tabla_resalta').innerHTML.split('}}').join('</span>').split('{{').join('<span style="background-color: yellow">');
}
function resetear() {
