...
function Filtrar_2()
{
    var table = document.getElementById('resultados_2');
    var filtro = document.getElementById('Txt_filtro_2').value.toLowerCase();
    filtro = filtro.trim(filtro);
    var cellsOfRow = "";
    var found = false;
    var compareWith = "";
...
function Filtrar_3()
{
    var table = document.getElementById('resultados_3');
    var filtro = document.getElementById('Txt_filtro_3').value.toLowerCase();
    filtro = filtro.trim(filtro);
    var cellsOfRow = "";
    var found = false;
    var compareWith = "";
