...
public class UsuarioJpaController {
    ...
    public boolean Registrar_usuario(String nbe, String apl, int dcm, int cdg, String usr, String pwd, int irl, int iar, String urg) {
        EntityManager etm = getEntityManager();
        etm.getTransaction().begin();
        try {
            Query q = etm.createNativeQuery("CALL `sp_usa_r_usuario`('" + nbe + "','" + apl + "','" + dcm + "','" + cdg + "','" + usr + "','" + pwd + "','" + irl + "','" + iar + "','" + urg + "')");
    ...
    public boolean Modificar_usuario(int ius, String nbe, String apl, int dcm, int cdg, String usr, String pwd, int irl, int iar) {
        EntityManager etm = getEntityManager();
        etm.getTransaction().begin();
        try {
            Query q = etm.createNativeQuery("CALL `sp_usa_m_usuario`('" + ius + "','" + nbe + "','" + apl + "','" + dcm + "','" + cdg + "','" + usr + "','" + pwd + "','" + irl + "','" + iar + "')");
            int exitoso = q.executeUpdate();
            etm.getTransaction().commit();
            etm.clear();
            etm.close();
