function Pager(tableName, itemsPerPage) {
    ...
    this.showPage = function(pageNumber) {
        ...
        newPageAnchor.style.color = '#880e4f';
    ...
    this.showPageNav = function(pagerName, positionId) {
        ...
        pagerHtml += '<span onclick="'+pagerName+'.last();" style="size:12px;" onmouseover="this.style.cursor=\'pointer\'"><b title="Ultimo" style="color:#000;">| Ultimo</b><b style="color:#000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total Paginas</b><b style="color:#880e4f;">|'+this.pages+'|</b></span>';
