...
<%@taglib uri="/WEB-INF/tlds/tld_confirmarcorreo.tld" prefix="confirmarCorreo" %>
<%@taglib uri="/WEB-INF/tlds/Alerta.tld" prefix="Alerts" %>
...
<html>
    ...
    <body onload="editable();editable2()">
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                <jsp:include page="MenuMail.jsp"></jsp:include>
                    <div class="" style="min-height: 700px; padding: 30px;">
                    <confirmarCorreo:confirmarcorreo/>
                </div>
            </div>
        </div>
                    <Alerts:LanzarAlertas/>
        <script>
