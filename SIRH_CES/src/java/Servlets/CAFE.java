...
import Controladores_BD.CafeJpaController;
...
public class CAFE extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CafeJpaController jpaccafe = new CafeJpaController();
            ...
            int id_ces_seg = 0;
            String user, password, estado = "";
            List lst_usuario = null;
            switch (opc) {
                case 1:
                    request.setAttribute("SIRH_CES", "CAFE");
                ...
                case 2:
                    ...
                    try {
                        ...
                        if (lst_datos_empleado != null) {
                            ...
                            lst_verificacion_existencia = jpaccafe.Verificacion_existencia_Cafe(obj_datos_personal[0].toString(), obj_datos_personal[6].toString(), year, mes);
                            if (lst_verificacion_existencia != null) {
                                ...
                                //<editor-fold defaultstate="collapsed" desc="EVALUACION Y VALIDACION">
                                if (etd.contains("Start")) {
                                    lst_evaluacion_tiempos = jpaccafe.Evaluar_tiempo_marcacion_anio_mes_Cafe(obj_datos_personal[0].toString(), obj_verificacion_existencia[5].toString(), obj_datos_personal[6].toString());
                                ...
                                if (eval_min.equals("SI")) {
                                    if (eval_hour.equals("NO_CIERRE")) {
                                        estado = obj_verificacion_existencia[5].toString().replace("Start", "End");
                                    } else {
                                        estado = obj_verificacion_existencia[5].toString();
                                    }
                                    resultado = jpaccafe.Registrar_marcacion_anio_mes_Cafe(obj_datos_personal[0].toString(), estado, year, mes, dia, obj_datos_personal[6].toString());
                                    ...
                                    List lst_ent = jpaccafe.ConsultarEntradasSalidas_Cafe(obj_datos_personal[0].toString(), obj_datos_personal[6].toString(), year, mes);
                                    ...
                                    if (resultado.equals("ENTRADA")) {
                                        ...
                                        H_emt = H_emt + ent;
                                        jpaccafe.Registrar_UbicacionMarcaicon_ENT_Cafe(H_emt, document, idCargo, year, mes);
                                        ...
                                        H_sal = H_sal + sal;
                                        jpaccafe.Registrar_UbicacionMarcaicon_Sal_Cafe(H_sal, document, idCargo, year, mes);
                                    }
//                                        //</editor-fold>
                                } else {
                                ...
                                if (resultado.equals("SALIDA")) {
                                    if (id_ces_seg == 0) {
                                        //<editor-fold defaultstate="collapsed" desc="REGISTROS SEGUIMIENTO SALIDA">
                                        try {
                                            jpaccafe.Registrar_seguimiento_anio_mes(obj_datos_personal[0].toString(), obj_datos_personal[6].toString(), datos, "CAFE", "Pendiente", year, mes);
                                        } catch (Exception e) {
                                        }
                                        //</editor-fold>
                                    }
                                    ...
                                    mes = etd.split("_")[2];
                                    dia = etd.split("_")[3];
                                    //<editor-fold defaultstate="collapsed" desc="ACTUALIZAR SEGUIMIENTO CON CALCULO">
                                    jpaccafe.Calculos_marcacion(obj_datos_personal[0].toString(), obj_datos_personal[6].toString(), year, mes, dia);
                                    //</editor-fold>
                                }
                            } else {
                                proceso = jpaccafe.Registrar_marcacion_anio_mes_Cafe(obj_datos_personal[0].toString(), obj_datos_personal[6].toString(), datos, "CAFE", "Generar", year, mes);
                                request.getRequestDispatcher("CAFE?opc=2&Txt_codbar=" + codbar).forward(request, response);
                                break;
                            }
                        } else {
                    ...
                    request.getRequestDispatcher("CAFE?opc=1&dts=" + datos).forward(request, response);
                    break;
                case 3:
                    ...
                    request.getRequestDispatcher("CAFE?opc=1&dts=0").forward(request, response);
                    break;
            }
        } catch (Exception ex) {
            request.getRequestDispatcher("CAFE?opc=1&dts=0").forward(request, response);
