...
public class Tag_cafe extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            if (pageContext.getRequest().getAttribute("SIRH_CES") != null) {
                if (pageContext.getRequest().getAttribute("SIRH_CES").equals("CAFE")) {
                    ...
                    out.print("<p style='    font-size: 23px;\n"
                            + "    color: #00fefe;\n"
                            + "    font-weight: bold;\n"
                            + "    text-shadow: 2px 2px #323232'>Ubicación: " + HostClient + "</p>");
                    out.print("</div>");
                    if (datos.equals("") || datos.equals("0")) {
                        ...
                        out.print("</tr>");
                        out.print("<tr>");
                        out.print("<td align='center'><br /><hr /><h2><b id='Tr_datos' class='colorEscanear'>ESCANEAR</b></h2></td>");
                        out.print("</tr>");
                        out.print("</table>");
                        out.print("</div>");
                        out.print("</center>");
                        ...
                        if (datos.contains("/FALLIDO")) {
                            ...
                            out.print("</tr>");
                            out.print("<tr>");
                            out.print("<td><br />YA CUENTA CON MARCACIÓN, EL SISTEMA PERMITE SALIR<br /> EN 5 MIN A PARTIR DE LA MARCACIÓN DE ENTRADA</td>");
                            out.print("</tr>");
                            out.print("<tr>");
                            out.print("<td align='center'><br /><hr /><h2><b id='Tr_datos' class='blanco'>EN 5 MINUTOS</b></h2></td>");
                            out.print("</tr>");
                            out.print("</table>");
                            out.print("</div>");
                            out.print("</center>");
...
//</editor-fold>
            ...
            Logger.getLogger(Tag_cafe.class.getName()).log(Level.SEVERE, null, ex);
        }
