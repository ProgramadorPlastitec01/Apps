...
<%@taglib  uri="/WEB-INF/tlds/Ces.tld" prefix="Ces" %>
...
<html>
    <head>
        ...
        <link href="Interfaz/Css/Css_principal.css" rel="stylesheet" type="text/css" media="all" />
        <title>CES</title>
            ...
            function Ocultar_datos() {
                try {
                    ...
                    if (datos.includes('ESCANEAR') || datos.includes('NO PERMITIDO')) {
                        ...
                        location.href = 'http://172.16.1.246:8080/SIRH_CES/CES?opc=1&dts=0';
                    }
                } catch (error) {
                    location.href = 'http://172.16.1.246:8080/SIRH_CES/CES?opc=3';
                }
                ...
                <tr>
                    <td rowspan="2" style="height: 60%;width: 50%;padding:10px;">
                        <div class="circle" style="height: 600px;">
                            <br />
                            <!--<img src="Interfaz/Gif/barcode-scan.gif" width="110px" style="border-radius: 24px;" onclick="javascript:location.href = 'CAFE?opc=1&dts=';">-->
                            <%
                                String ipAddress2 = request.getRemoteAddr();
                                ParametrosJpaController JpaParametros2 = new ParametrosJpaController();
                                List lst_parametros2 = null;
                                lst_parametros2 = JpaParametros2.ConsultarParametrosxCategoria("Ips_permitidas");
                            ...
                            %>
                            <span class="fas fa-fingerprint fa-size_medio" style='color:#fff' onclick="javascript:location.href = 'CAFE?opc=1&dts=';"></span>
                            <%
                            } else {
                            %>
                            <span class="fas fa-fingerprint fa-size_medio" style='color:#fff'></span>
                            <%
                                    }
                                }
                            %>
                            <h1><b style='text-shadow:none'></b>MARCACIÓN</h1>
                            <hr />
                            <br />
                            El sistema lleva registro de las marcaciones del<br /> de entrada y salida del personal a tráves de<br />la lectura de un codigo de barras asignado.
                            <br /><br />
                            <hr />
                            <br />
                            <div id="txt3" style="font-size: 35px;color:#fff;font-weight: bold;text-shadow: 2px 2px #852748;"></div>
                            <div id="txt" style="font-size: 26px;color:#852748;font-weight: bold;"></div>
                            <div id="txt2" style="font-size: 35px;color:#fff;font-weight: bold;text-shadow: 2px 2px #852748;"></div>
                            <div id="txt1" style="font-size: 24px;color:#f1a74f;font-weight: bold;text-shadow: 2px 2px #c85f4c;"></div>
                        </div>
                    </td>
                    <td style="height:5%;width:50%;padding:10px;">
                        <div class='circle' style="height: 100px">
                            <form action='CES?opc=2' method='post'>
