            ...
            if (framePositions) {
                for (let placement of segPlacements) {
                    ...
                    nodes.push(y("div", { className: 'fc-daygrid-event-harness' + (isAbsolute ? ' fc-daygrid-event-harness-abs' : ''), key: key, ref: isMirror ? null : this.segHarnessRefs.createRef(key), style: {
                            visibility: segPlacements.length > 1 ? (isVisible ? '' : 'hidden') : (isVisible ? '' : 'visible'),
                            marginTop: isAbsolute ? '' : placement.marginTop,
                            top: isAbsolute 
                                ? placement.absoluteTop + (segPlacements.length > 1 ? 5 * segPlacements.indexOf(placement) : 0)
                                : '',
                            left,
                            right,
    ...
    */
    ...
    class SingleMonth extends DateComponent {
        ...
        render() {
            ...
            return (y("div", { ref: props.elRef, "data-date": props.isoDateStr, className: "fc-multimonth-month", style: { width: '33%' ,padding: '0 1.2em 1.2em'   }, role: "grid", "aria-labelledby": state.labelId },
//            return (y("div", { ref: props.elRef, "data-date": props.isoDateStr, className: "fc-multimonth-month", style: { width: props.width || '30%' }, role: "grid", "aria-labelledby": state.labelId },
